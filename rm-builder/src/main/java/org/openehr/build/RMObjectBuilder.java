...
/*
  ...
  This file is copied from ethercis.
  Attemts to merge the version from ethercis with the official 1.0.14 version took too much effort.

  There are some I_VBean things in here which are currently commented out.
  Perhaps these need to be included to work with ethercis...
			...
			if (value != null) {
				...
				if (interfaces != null) {
					for (Class<?> interfaze : interfaces) {
						if ("I_VBeanWrapper".equals(interfaze.getSimpleName())) {
							throw new RuntimeException("TODO: solve this cyclic dependency...");
						}
					}
				}
			}
